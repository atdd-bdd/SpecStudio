...
QString GoGenerator::toMethodName(const Step& step)
{
...
QVector<GoGenerator::GlueSig> GoGenerator::collectGlueSigs(const SpectableFile& file, QStringList* conflicts)
{
    ...
    auto collectSteps = [&](const QVector<Step>& steps) {
        for (const Step& step : steps) {
            ...
            if (step.hasDocString) {
                ...
                record(meth, { meth, effName + "String" }, step.line);
            } else {
